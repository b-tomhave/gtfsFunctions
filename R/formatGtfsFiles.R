...
formatGTFSObject <- function(gtfsZipPath){
  ...
  zipFileNames <- unzip(zipfile = gtfsZipPath, list = T )$Name
...
# x <- tidytransit::read_gtfs("/Users/bentomhave/Documents/Data_GTFS/Summer2021/CTA_June21.zip")
